...
# color value referece 
top_left_frame_bg="#5c4ce1"
top_right_frame_bg="#867ae9"

app=Tk()
#adding geometry and components
...
#adding frames[ Frame()  this command will create frame and ask ceratin parameter
...
search_vaccine_btn = Button(app, image=search_vaccine_image, bg= top_right_frame_bg, command = '', relief= RAISED)
...
# creating textbox to display results

#making column for each status (sttatus,dose1,dose2,age-group etc)
result_box_avl=Text(app,height=30,width=9,bg='#293241',fg='#ecfcff', relief=FLAT, font='verdana 10')
...
# displaying clock and updating timestamp in real time
...
#checkbox for updating date manually or by user
